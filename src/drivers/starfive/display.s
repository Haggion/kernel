...
.equ SYSCRG_CLK_NOC_DISP,      0x3C * 4
.equ SYSCRG_CLK_VOUT_SRC,      0x3A * 4
.equ SYSCRG_CLK_TOP_VOUT_AXI,  0x3E * 4
.equ SYSCRG_CLK_TOP_VOUT_AHB,  0x3D * 4

.equ VOUTCRG_CLK_PIX,          0x07 * 4
.equ VOUTCRG_CLK_PIX1,         0x08 * 4
.equ VOUTCRG_CLK_AXI,          0x04 * 4
.equ VOUTCRG_CLK_CORE,         0x05 * 4
.equ VOUTCRG_CLK_AHB,          0x06 * 4
.equ VOUTCRG_CLK_TOP_LCD,      0x09 * 4
.equ VOUTCRG_CLK_DC,           0x01 * 4
...
starfive_enable_display:
   ...
   lw   t1, 0(t0)             # read current SW_PWRON
...
1: li   t0, PMU_BASE + PMU_CUR_MODE
   ...
   li   t0, DC_CH_BASE + DC_CH0_START1
   li   t1, 0
   sw   t1, 0(t0)  
